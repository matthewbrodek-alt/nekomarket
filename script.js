...
const PAGE_CONTENT = {
  ...
  'guide-to-affinity': {
    title_ru: 'Руководство по стихиям',
  ...
  'champion-ascension': {
    title_ru: 'Пробуждение чемпионов',
    title_en: 'Champion Ascension',
    icon: 'fa-arrow-up-right-dots',
    content_ru: '<p>Здесь будет контент страницы «Пробуждение чемпионов».</p>',
  ...
  'marius-missions': {
    title_ru: 'Миссии Мариуса Бравого',
